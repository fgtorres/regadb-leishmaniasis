...
public abstract class GridForm extends FormWidget{
	...
	public GridForm(WString name, InteractionState interactionState, TreeMenuNode lastItem) {
		super(name, interactionState);
	...
	protected void addRow(){
		...
		for(Test test : tests){
			...
			table.getElementAt(i, j++).addWidget(f.getWidget());
		}
