package com.pharmadm.num.dhb.DhbScientificCurves;

import com.pharmadm.num.dhb.DhbInterfaces.PointSeries;
import com.pharmadm.num.dhb.DhbStatistics.FixedStatisticalMoments;
import com.pharmadm.num.dhb.DhbStatistics.ScaledProbabilityDensityFunction;
import com.pharmadm.num.dhb.DhbStatistics.ChiSquareDistribution;
import com.pharmadm.num.dhb.DhbFunctionEvaluation.DhbMath;
import com.pharmadm.num.dhb.DhbEstimation.WeightedPoint;
/**
...
public class Histogram implements PointSeries {
    ...
    throws IllegalArgumentException {
        if ( from >= to ) {
            if (from == to) {  // kdg May 07 2004  Used to crash when first cach-size accumulations were the same.
                from = from - 1;
                to = to + 1;
            } else {
