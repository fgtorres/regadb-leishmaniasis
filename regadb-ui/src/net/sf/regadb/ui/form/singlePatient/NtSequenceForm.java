...
public class NtSequenceForm extends WContainerWidget{
	...
	private IFormField getTextField(TestType tt){
		return getTextField(tt, getInteractionState());
	}
	
	@SuppressWarnings("unchecked")
	private IFormField getTextField(TestType tt, InteractionState interactionState){
		ValueTypes vt = ValueTypes.getValueType(tt.getValueType());
		IFormField f = FormField.getTextField(
				vt,
				interactionState,
				getViralIsolateForm());
