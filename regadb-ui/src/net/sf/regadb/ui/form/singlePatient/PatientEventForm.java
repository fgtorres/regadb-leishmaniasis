...
public class PatientEventForm extends ObjectForm<PatientEventValue>
{
	...
	private void fillData() {
		...
		if( getInteractionState() != InteractionState.Adding )
        {
            ...
            {
            	((IFormTextField)ffValue).setText(getObject().getValue());
            }
        }
	...
	private void updateValue()
	{
        ...
        valueContainer.addWidget(ffValue.getWidget());
	}
	...
	public void saveData() {
		...
		{
			getObject().setValue( ((IFormTextField)ffValue).getFormText() );
		}
