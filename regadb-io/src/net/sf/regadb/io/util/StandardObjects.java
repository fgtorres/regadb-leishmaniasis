...
public class StandardObjects {
    ...
    private static ValueType imageValueType;
...
//    private static Test rega71Test;
    ...
    static {
        ...
        imageValueType			= createValueType("image");
...
//        rega71Test = createResistanceTest("RegaHIV1V7.1.xml", "REGA v7.1");
    ...
    public static ValueType getImageValueType() {
...
//    }
    ...
    private static Attribute createEthnicity()
    {
        ...
        ethnicity.getAttributeNominalValues().add(new AttributeNominalValue(ethnicity, "other"));
        ethnicity.getAttributeNominalValues().add(new AttributeNominalValue(ethnicity, "missing"));
